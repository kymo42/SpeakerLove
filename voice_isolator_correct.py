"""
Voice Isolator - CORRECT VERSION
Properly separates microphones from loopback devices
"""
...
class GUI:
    ...
    def __init__(self, root):
        ...
        ttk.Label(dev_frame, text="(Voicemeeter, Stereo Mix, What U Hear, etc.)", 
